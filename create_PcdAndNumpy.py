...
def scan(save_dir, save_numpy, Motor_type, scanner, sequence_Motor):
    ...
    bpy.context.object.kinect_xres = 760
    bpy.context.object.kinect_yres = 600
...
def export_png(image_save_path, sequence_Motor) :
    ...
    if bpy.data.objects['Camera.001'] :
        ...
        save_image_path = image_save_path + '\\' + 'scan_iamge_' + sequence_Motor + '.png'
...
def main():
    ...
    if scan_mode == 'all_folders' :
        ...
        bpy.data.objects['Camera'].location = (0, -4.98905, 1.60000)
